...
class TravelPlan:
    ...
    def enumeration(self, hour_constraint: int) -> None:
        self.route.append(self.start)
        self.enumeration_recursion(hour_constraint)
        return None


    def enumeration_recursion(self, hour_constraint: int):
...
if __name__ == "__main__":
    ...
    myplan.enumeration(hour_constraint=60)
